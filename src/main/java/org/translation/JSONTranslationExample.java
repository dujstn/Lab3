...
/**
 * A minimal example of reading and using the JSON data from
...
public class JSONTranslationExample {
    ...
    // Note: CheckStyle is configured so that we are allowed to omit javadoc for
    // constructors
    ...
    // TODO Task: Complete the method below to generalize the above to get the
    // country name
    // for any country code and language code from sample.json.

    /**
     * Returns the name of the country based on the provided country and language
     * codes.
     * 
    ...
    public String getCountryNameTranslation(String countryCode, String languageCode) {
        JSONObject country = jsonArray.getJSONArray(jsonArray.indexOf(countryCode));
